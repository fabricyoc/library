...
<div id='createFuncionarioModal' class="modal-wrapper @if ($errors->any()) modal-is-open @endif">
    ...
    <div class="modal modal-centered">
        <div class="modal-content shadow-lg p-5">
            ...
            <!-- Modal content -->
            <form id='form_id' class="w-full" method="post" action="{{route('funcionarios.store')}}">
                @csrf
                {{-- Linha 1 --}}
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-grey-darker border rounded py-3 px-3 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600
                                ...
                                @else
                                    border-gray-200
                                @endif"
                            id="name" name="name" type="text" placeholder="Nome do funcionário" value="{{old('name')}}">
                        ...
                        <input
                            class="appearance-none block w-full bg-gray-200 text-grey-darker border rounded py-3 px-2 leading-tight focus:outline-none focus:bg-white-500 focus:border-gray-600
                                ...
                                @else
                                    border-gray-200
                                @endif"
                            id="email" name="email" type="text" placeholder="funcionario@eeccam.com" value="{{old('email')}}">
                        @error('email')
                            <p class="text-red-500 text-xs italic">
                                {{$message}}
                            </p>
