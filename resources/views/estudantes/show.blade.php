...
<div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
    <div class="shadow-lg bg-red-vibrant border-l-8 hover:bg-red-vibrant-dark border-red-vibrant-dark mb-2 p-2 md:w-full mx-2">
        ...
        <div class="p-4 flex justify-between">
            ...
            <div class="no-underline text-white text-2xl font-bold" title="Exibir informações do estudante">
                Exibir
            </div>
        </div>
    </div>
...
<form action="{{route('estudantes.update', $user->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-4">
        <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
            {{-- Cabeçalho dos dados do estudante --}}
        ...
        <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
            ...
            <div class="p-3">
                    ...
                    <div class="mt-3 flex justify-between">
                        ...
                        <div>
                            <a href="{{ route('estudantes.edit', $user->id) }}">
                                <input type="button" value="Editar" class='bg-green-500 hover:bg-green-800 text-white font-bold py-2 px-4 rounded cursor-pointer' title="Ir editar o estudante">
                            </a>
                        </div>
                    </div>
                {{-- </form> --}}
